...
OutMessage.prototype.end= function(payload) {
  ...
  console.log('block2Buff0', block2Buff)
  console.log('this._request.options', this._request.options)
  var requestedBlockOption
  ...
  console.log('requestedBlockOption.size', requestedBlockOption.size)
  ...
  console.log('requestedBlockOption.num', requestedBlockOption.num)
